# https://github.com/khalednasr/nn-numerosity-zero/blob/main/stim_generation.py
...
# pr450 original function
def generate_image_with_numerousity(n, background_func, img_size, n_channels, max_iter, sample_fn, sample_fn_args, background_args, verify_fn, draw_fn):
...
def generate_dataset(numerosities,
    ...
    for ii, n in enumerate(numerosities):
        for k in range(num_images_per_numerosity):
            ...
            img = generate_image_with_numerousity(n, background_func, img_size, n_channels, max_iter, sample_fn, sample_fn_args, background_args, verify_fn, draw_fn)
