...
rules_dict = \
    ...
    # pr450: one modality only
    'one_ring': ['delaygo_one_ring']
    }
...
def get_num_ring(ruleset):
    ...
    return 3 if ruleset=='oicdmc' else 1 if ruleset=='one_ring' else 2
...
def delaygo_(config, mode, anti_response, one_ring=False, **kwargs):
    '''
...
def delaygoonering(config, mode, **kwargs):
    return delaygo_(config, mode, False, one_ring=True, **kwargs)
...
rule_mapping = {'testinit': test_init,
                ...
                'delaygo_one_ring': delaygoonering
                }
...
rule_name    = {'reactgo': 'RT Go',
                ...
                'delaygo_one_ring': 'Dly Go one ring'
                }
