...
class WeightWatcher(ABC):
    ...
    """
    def __init__(self, initial_weight: T, stats_dimension: int) -> None:
    ...
    def register_weight(self, weight_matrix: T) -> None:
    ...
    @abstractmethod
    def __register_weight__(self, weight_matrix: T) -> None:
        ...
